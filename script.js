...
$(document).ready(function() {
    ...
    if ($('.resource_item.contact_us').length) {
    ...
    function tenweb_init_ZE() {
        if ( jQuery( '#smooch-snippet' ).length === 0) {
            ...
            Smooch.init({
                ...
                businessIconUrl: "https://10-web-for-upload.s3.eu-central-1.amazonaws.com/dashboard/10Web-logo-n.png",
                buttonIconUrl: "https://10-web-for-upload.s3.eu-central-1.amazonaws.com/dashboard/chat-logo.png",
                buttonWidth: "66",
                buttonHeight: "64"
    ...
    $("footer .footer-menu_title").click(function () {
...
$(window).on("resize", function () {
    ...
    if ($('.footer_widget_nav_menu > div').length) {
        if (matchMedia('screen and (min-width: 1260px)').matches) {
            ...
            $("footer .footer_widget_nav_menu .footer-menu_title").removeClass("active");
        }
    }
});
